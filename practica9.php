            ...
            <?php
             ...
             // echo "<h1 class=display-1>hola programando en php</h1>";
              ...
              <div class="row"> 
               ...
               <div class="col-12 col-sm-3"><h1 class=text-cust>Nombre</h1></div>
              <div class="col-12 col-sm-2"><h1 class=text-cust>Apellido</h1></div>
               <div class="col-12 col-sm-1"><h1 class=text-cust>Edad</h1></div>
               <div class="col-12 col-sm-3"><h1 class=text-cust>Email</h1></div>
              <div class="col-12 col-sm-3"><h1 class=text-cust>Dni</h1></div>
             </div>
